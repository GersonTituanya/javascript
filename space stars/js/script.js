...
function canvasStars(){
    ...
    //Llamo a la función que pinta el combustible

    setTimeout(pintarCombustible,1000);
...
function pintarCombustible(){
    ...
    for (i=0; i<2; i++){
        ...
        //Compruebo que no hay combustible en la nave
...
function actualizarContador(){
    ...
    if (contador == 0){
        ...
        var mensaje = "¡Lo siento! Te has quedado sin puntos.<br> Pincha AQUÍ para volver a intentarlo.";
